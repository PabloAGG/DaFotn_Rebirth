...
<main>
    ...
    <form action="BACK/EditPerfil.php" id="FormLogin" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group">
          ...
          <div class="input-group">
            <input required="" type="text" name="Pagina_usuario" autocomplete="off" class="input">
        ...
        <div class="input-group">
          ...
          <div id="botones"><button id="btn-REG">Completar</button> <button id="btn-Cnl">Regresar</button></div>
    </form>
